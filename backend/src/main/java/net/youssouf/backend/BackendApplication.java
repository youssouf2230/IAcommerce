...
public class BackendApplication {
        ...
        public PasswordEncoder passwordEncoder() {
                // This bean is correctly defined, but we need to inject it into the runner.
        ...
        CommandLineRunner initData(
                        ...
                        PasswordEncoder passwordEncoder // FIX: Inject the PasswordEncoder
        ) {
                return args -> {
                        ...
                        // FIX 2: Encode the password before saving
                        adminUser.setPassword(passwordEncoder.encode("admin"));

                        // FIX 3: Assign roles to the user
                        adminUser.setRoles(Set.of(adminRole, clientRole)); // Give the admin both roles
                        ...
                        // --- Your existing data seeding (which is good) ---
                        ...
                        // ... (rest of your category and product creation code is fine)
                        ...
                        productColorRepository.saveAll(List.of(
                                        new ProductColor(null, "Space Black",
                                                        "https://electrosalam.ma/cdn/shop/files/10_11_87bd80b1-d4e9-473f-86e1-eb5cbbfaab50.png?v=1751299222&width=1000",
                                                        products.get(0)),
                                        new ProductColor(null, "Phantom Black",
                                                        "https://gtelstore.ma/wp-content/uploads/2023/12/samsung-galaxy-s23-256go-dual-sim-sm-s911bzecmwd_1.png",
                                                        products.get(1)),
                                        new ProductColor(null, "Silver",
                                                        "https://uno.ma/pub/media/catalog/product/cache/af8d7fd2c4634f9c922fba76a4a30c04/l/d/ld0005959647_1.jpeg",
                                                        products.get(2)),
                                        new ProductColor(null, "Black",
                                                        "https://m.media-amazon.com/images/I/81Vep45DQ4L._AC_SL1500_.jpg",
                                                        products.get(3)),
                                        new ProductColor(null, "Black",
                                                        "https://www.sony.com/image/6145c1d32e6ac8e63a46c912dc33c5bb?fmt=pjpeg&wid=330&bgcolor=FFFFFF&bgc=FFFFFF",
                                                        products.get(4)),
                                        new ProductColor(null, "Blue",
                                                        "https://www.mediazone.ma/product/images/11912-huOL0Ml8/enceinte-portable-sans-fil-bluetooth-jbl-charge-5-rouge.jpg",
                                                        products.get(5)),
                                        new ProductColor(null, "Gray",
                                                        "https://www.ultrapc.ma/19003-large_default/logitech-mx-master-3-graphite.jpg",
                                                        products.get(6)),
                                        new ProductColor(null, "Black",
                                                        "https://www.pcgamer.ma/259714-large_default/samsung-27-led-f27t350fhm-moniteur.jpg",
                                                        products.get(7)),
                                        new ProductColor(null, "White",
                                                        "https://mytechnology.lk/wp-content/uploads/2024/03/google-pixel-8.jpg",
                                                        products.get(8)),
                                        new ProductColor(null, "White",
